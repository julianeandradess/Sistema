...
public class contaCorrente implements Conta{
    ...
    public contaCorrente(Cliente cliente, Integer numeroConta, Boolean status, Double saldo, List<Double> extrato) {
    ...
    public contaCorrente(Cliente cliente, Integer numeroConta, Boolean status, Double saldo) {
        this.cliente = cliente;
        this.numeroConta = numeroConta;
        this.status = status;
        this.saldo = saldo;
    ...
    public Optional<List<Double>> getExtrato() {
        if (extrato.isEmpty()){
            System.out.println("Extrato Conta corrente: Nenhuma movimentação");
            return Optional.empty();
        }
